...
def extraer_datos_empleo(request, job_context):
    ...
    job_title_match = get_summaryImage(request, job_context)
    ...
    request.session['job_title'] = job_title_match
    request.session['job_description'] = job_description

    return job_title_match, job_description
    ...
    if not poster_url:
        ai_content = """
            ...
            <html>
              ...
              <body>
                <p>Error: No se proporcionó una URL válida para la imagen.</p>
              </body>
            </html>
            %%EOF
        """
    else:
        # Genera el contenido AI con la imagen
        ai_content = f"""
            %!PS-Adobe-3.0
            %%BoundingBox: 0 0 600 800
            %%Creator: Custom HTML to AI
            ...
            <html>
              ...
              <body>
                <img src="{poster_url}" alt="Imagen generada por IA">
              </body>
            </html>
            %%EOF
        """
